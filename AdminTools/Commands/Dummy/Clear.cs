...
namespace AdminTools.Commands.Dummy
{
    public class Clear : ICommand
    {
        ...
        public string Description { get; } = "Removes all spawned dummies from a specified user";
        ...
        public bool Execute(ArraySegment<string> arguments, ICommandSender sender, out string response)
        {
            ...
            {
                response = "Usage:\ndummy clear (player id / name) (minimum index) (maximum index)\n\nNOTE: Minimum index < Maximum index, You can remove from a range of all the dummies you spawned (From 1 to (how many you spawned))";
                return false;
            }
